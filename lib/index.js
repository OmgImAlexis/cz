    ...
    _createClass(Cz, [{
        ...
        value: function get(prop) {
            if (arguments.length === 0) {
                return Object.assign((0, _utils.weakToJSON)(_defaults), (0, _utils.weakToJSON)(_config));
            }
            return (0, _lodash.get)(_config, prop.replace(':', '.'));
        }
    }, {
        key: 'set',
        ...
        value: function save(newPath) {
            _fs2.default.writeFileSync(newPath || currentPath, JSON.stringify(_config, null, 4) + '\n', 'utf8');
        }
    }, {
        key: 'args',
